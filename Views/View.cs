...
namespace Pulse.Data.Views
{
    
    //public sealed class View : IReadable
    //{
    ...
    //    public View(Table Data, ScalarExpressionCollection Select, Filter Where)
    //    {
    //        this._Source = Data;
    //        this._Where = Where;
    //        this._Select = Select;
    ...
    //    public View(Table Data, ScalarExpressionCollection Select)
    //        : this(Data, Select, Filter.TrueForAll)
    //    {
    //    }

    //    public View(Table Data)
    //        : this(Data, new ScalarExpressionCollection(Data.Columns, 0), Filter.TrueForAll)
    //    {
    //    }
    ...
    public class ViewedRecordReader : RecordReader
    {
        ...
        public ViewedRecordReader(Table Data, ScalarExpressionCollection Select, Filter Where, FieldResolver Resolver, RecordKey LKey, RecordKey UKey)
            : base()
        {
        ...
        public ViewedRecordReader(Table Data, ScalarExpressionCollection Select, Filter Where, FieldResolver Resolver)
