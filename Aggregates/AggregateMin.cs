...
namespace Pulse.Aggregates
{
    ...
    public class AggregateMin : Aggregate
    {
        ...
        public AggregateMin(Expression Value, Filter Filter)
            : base(Filter)
        {
            this._Value = Value;
        }

        public AggregateMin(Expression Value)
        ...
        {
            Work[Offset] = Cell.MaxValue(this.AggregateAffinity(), this.AggregateSize());
        }
