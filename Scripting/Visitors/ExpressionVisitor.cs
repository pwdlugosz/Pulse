...
namespace Pulse.Scripting
{
    ...
    public sealed class ExpressionVisitor : PulseParserBaseVisitor<IExpression>
    {
        ...
        public override IExpression VisitExpressionName(PulseParser.ExpressionNameContext context)
        {
            ...
            if (this._Map[0].Exists(lib, ObjectStore.ObjectAffinity.Record))
            {
                RecordExpression rex = new RecordExpressionStoreRef(this._Host, null, lib, this._Map[0]);
        ...
        public override IExpression VisitExpressionSelect(PulseParser.ExpressionSelectContext context)
        {
            ...
            TableExpression t = ie.Table;
            string a_prime = t.Alias;

            // Switch out the resolver //
            this._Map.Local.DeclareRecord(a_prime, new AssociativeRecord(t.Columns));
            ...
            TableExpression x = new TableExpressionSelect(this._Host, null, select, where, t.Alias);
            x.AddChild(t);
            ...
            // Remove Map //
            this._Map.Local.RemoveRecord(a_prime);

            // Get the output database and name //
            x.Database = ScriptingHelper.GetLibName(context.var_name());
            x.Name = ScriptingHelper.GetVarName(context.var_name());
        ...
        public override IExpression VisitExpressionJoin(PulseParser.ExpressionJoinContext context)
        {
            ...
            // Get the output database and name //
            tej.Database = ScriptingHelper.GetLibName(context.var_name());
            tej.Name = ScriptingHelper.GetVarName(context.var_name());
        ...
        public override IExpression VisitExpressionGroup1(PulseParser.ExpressionGroup1Context context)
        {
            ...
            // Get the select //
            ScalarExpressionSet group = this.RenderNFrame(context.nframe()[0]);
        ...
        public override IExpression VisitExpressionGroup3(PulseParser.ExpressionGroup3Context context)
        {
            ...
            ScalarExpressionSet select = select = this.RenderNFrame(context.nframe());
        ...
        {
            return base.VisitExpressionFunction(context);
        }
